...
const Home: NextPage = () => {
  ...
  //   fetch("/api/steam/76561197997523600")
  //     .then((res) => res.json())
  //     .then((data) => {
  //       console.log(data);
  //     });
  ...
  const fetchAchivementData = () => {
    ofetch("/api/steam/76561197997523600/check-achevement", {
      method: "POST",
      body: {
        appid: 1145360,
        name: "AchClearHeatGate",
      },
    }).then((data) => {
      console.log(data);
    });
  ...
  const mintWithSignature = async () => {
    try {
      ...
      const res = await ofetch(
        "/api/steam/76561197997523600/check-achevement",
        {
          method: "POST",
          body: {
            authorAddress: address, // Address of the current user
